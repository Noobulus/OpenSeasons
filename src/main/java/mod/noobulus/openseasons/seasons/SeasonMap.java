...
public class SeasonMap {
    ...
    private static final Season InvalidSeason = new Season(2, 0f, 0f, "INVALID");
    ...
    public static void newSeason(int days, float tempMod, float humidMod, String name) {
        Season season = new Season(days, tempMod, humidMod, name);
